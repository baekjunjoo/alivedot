...
const animals: Array<{
  ...
  { id: "octopus", name: "문어", action: "다리를 흔들며 움직여요", instruction: "동그란 머리 아래에 여덟 개의 긴 다리가 있어요.", feature: "아래로 갈라진 여덟 다리를 세어보세요", voice: "문어는 동그란 머리 아래의 여덟 다리를 흔들며 움직여요. 아래로 갈라진 긴 다리를 세어볼까요?", emoji: "🐙", category: "water", quizAnswer: 0 },
  { id: "turtle", name: "거북이", action: "느긋하게 헤엄쳐요", instruction: "둥근 등껍질 안에 갈라진 무늬와 네 개의 지느러미가 있어요.", feature: "등껍질의 갈라진 무늬를 찾아보세요", voice: "바다거북은 둥근 등껍질 안의 갈라진 무늬와 네 지느러미를 이용해 물속을 느긋하게 헤엄쳐요.", emoji: "🐢", category: "water", quizAnswer: 0 },
  { id: "owl", name: "부엉이", action: "날개를 펴고 날아요", instruction: "커다란 둥근 두 눈과 뾰족한 부리, 넓은 날개가 있어요.", feature: "두 둥근 눈과 가운데 부리를 찾아보세요", voice: "부엉이는 커다란 두 눈과 가운데의 뾰족한 부리를 가지고 넓은 날개를 펴고 날아요.", emoji: "🦉", category: "sky", quizAnswer: 1 },
  { id: "butterfly", name: "나비", action: "팔랑팔랑 날아요", instruction: "가운데의 가는 몸통 양옆에 두 개의 큰 날개가 있어요.", feature: "가운데 몸통과 양쪽 큰 날개를 찾아보세요", voice: "나비는 가운데의 가는 몸통 양옆으로 두 큰 날개를 팔랑팔랑 움직이며 꽃 사이를 날아요.", emoji: "🦋", category: "sky", quizAnswer: 1 },
  { id: "bee", name: "꿀벌", action: "윙윙 날아요", instruction: "작은 몸의 배에 세 줄무늬와 빠르게 움직이는 두 날개가 있어요.", feature: "배에 있는 세 줄무늬를 찾아보세요", voice: "꿀벌은 작은 몸의 배에 있는 세 줄무늬와 작은 날개를 빠르게 움직이며 윙윙 날아요.", emoji: "🐝", category: "sky", quizAnswer: 1 },
  ...
  { id: "lion", name: "사자", action: "튼튼하게 걸어요", instruction: "커다란 머리 주변에 뾰족뾰족 퍼진 갈기가 있어요.", feature: "머리 둘레의 둥근 갈기를 찾아보세요", voice: "사자는 튼튼한 네 다리로 걸어요. 머리 둘레에서 뾰족뾰족 퍼진 둥근 갈기를 느껴 보세요.", emoji: "🦁", category: "land", quizAnswer: 3 },
  { id: "elephant", name: "코끼리", action: "쿵쿵 걸어요", instruction: "긴 코 끝, 커다란 귀, 두 개의 엄니가 있어요.", feature: "얼굴에서 길게 내려오는 코를 찾아보세요", voice: "코끼리는 얼굴에서 길게 내려온 코와 커다란 귀를 흔들며 커다란 발로 쿵쿵 걸어요.", emoji: "🐘", category: "land", quizAnswer: 3 },
  { id: "monkey", name: "원숭이", action: "나무에서 폴짝 뛰어요", instruction: "긴 팔과 동그랗게 말린 긴 꼬리가 있어요.", feature: "동그랗게 말린 긴 꼬리를 찾아보세요", voice: "원숭이는 긴 팔로 나뭇가지를 잡고 폴짝폴짝 뛰어요. 몸 뒤쪽의 동그랗게 말린 긴 꼬리를 찾아보세요.", emoji: "🐵", category: "land", quizAnswer: 2 },
